...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    if (!hyperspeed.current) {
      console.error('Hyperspeed: Container ref not available');
      return;
    }

    const container = hyperspeed.current;
    console.log('Hyperspeed: Initializing with container:', {
    ...
    // Initialize directly without loading assets
    console.log('Hyperspeed: Initializing...');
    myApp.init();
